...
from custom_func_LID_NS_FVM_Re import PdeModel, get_ibc_and_inner_data
...
# Training the model
history = cm.run(epochs=100000, proj_name="ICCS_FVD",
                 verbose_freq=1000, error_freq=5000)


# Save trained model
model.save('saved_model/ICCS_my_model_Re_1000_layers_5_lrs.keras')
